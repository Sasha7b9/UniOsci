...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       cConsole_SizeFont,                                                                     //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –‡ÁÏÂ ¯ËÙÚ‡ ---
    "–‡ÁÏÂ ¯ËÙÚ‡", "Size font",
    "",
    "",
    "5", "5",
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       cConsole_ModeStop,                                                                     //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –ÂÊ. ÓÒÚ‡ÌÓ‚‡ ---
    "–ÂÊ. ÓÒÚ‡ÌÓ‚‡", "Mode stop",
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(   cConsole_Registers_ShowAll,                                                    //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - œÓÍ‡Á˚‚‡Ú¸ ‚ÒÂ ---
    "œÓÍ‡Á˚‚‡Ú¸ ‚ÒÂ", "Show all",
...
DEF_CHOICE_2(       cConsole_Registers_RD_FL,                                                           //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - RD_FL ---
    "RD_FL", "RD_FL",
    "",
    "",
    DISABLE_RU, DISABLE_EN,
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       cConsole_Registers_RShiftA,                                                      //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - U ÒÏ. 1Í ---
    "U ÒÏ. 1Í", "U shift 1ch",
    "",
    "",
    DISABLE_RU, DISABLE_EN,
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       cConsole_Registers_RShiftB,                                                      //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - U ÒÏ. 2Í ---
    "U ÒÏ. 2Í", "U shift 2ch",
    "",
    "",
    DISABLE_RU, DISABLE_EN,
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       cConsole_Registers_TrigLev,                                                      //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - U ÒËÌı. ---
    "U ÒËÌı.", "U trig.",
    "",
    "",
    DISABLE_RU, DISABLE_EN,
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       cConsole_Registers_RangeA,                                                    //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - ¬ŒÀ‹“/ƒ≈À 1 ---
    "¬ŒÀ‹“/ƒ≈À 1", "Range 1",
    "",
    "",
    DISABLE_RU, DISABLE_EN,
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       cConsole_Registers_RangeB,                                                    //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - ¬ŒÀ‹“/ƒ≈À 2 ---
    "¬ŒÀ‹“/ƒ≈À 2", "Range 2",
    "",
    "",
    DISABLE_RU, DISABLE_EN,
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       cConsole_Registers_TrigParam,                                               //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - œ‡‡Ï. ÒËÌı. ---
    "œ‡‡Ï. ÒËÌı.", "Trig param",
    "",
    "",
    DISABLE_RU, DISABLE_EN,
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       cConsole_Registers_ChanParamA,                                              //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - œ‡‡Ï. Í‡Ì. 2 ---
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       cConsole_Registers_ChanParamB,                                              //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - œ‡‡Ï. Í‡Ì. 2 ---
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       cConsole_Registers_TBase,                                                       //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - ¬–≈Ãﬂ/ƒ≈À ---
    "¬–≈Ãﬂ/ƒ≈À", "TBase",
    "",
    "",
    DISABLE_RU, DISABLE_EN,
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       cConsole_Registers_TShift,                                                          //--- Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - “ ÒÏ. ---
    "“ ÒÏ.", "tShift",
    "",
    "",
    DISABLE_RU, DISABLE_EN,
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       cRand_ShowInfo,                                                                          //--- Œ“À¿ƒ ¿ - –¿Õƒ-“Œ– - »ÌÙÓÏ‡ˆËˇ ---
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
DEF_CHOICE_2(       gRand_ShowStat,                                                                          //--- Œ“À¿ƒ ¿ - –¿Õƒ-“Œ– - —Ú‡ÚËÒÚËÍ‡ ---
    "—Ú‡ÚËÒÚËÍ‡", "Statistics",
...
DEF_CHOICE_2(       cDisplayOrientation,                                                                                //--- Œ“À¿ƒ ¿ - ŒËÂÌÚ‡ˆËˇ ---
...
DEF_CHOICE_2(       cStats,                                                                                             //--- Œ“À¿ƒ ¿ - —Ú‡ÚËÒÚËÍ‡ ---
    "—Ú‡ÚËÒÚËÍ‡", "Statistics",
    "œÓÍ‡Á˚‚‡Ú¸/ÌÂ ÔÓÍ‡Á˚‚‡Ú¸ ‚ÂÏˇ/Í‡‰, Í‡‰Ó‚ ‚ ÒÂÍÛÌ‰Û, ÍÓÎË˜ÂÒÚ‚Ó ÒË„Ì‡ÎÓ‚ Ò ÔÓÒÎÂ‰ÌËÏË Ì‡ÒÚÓÈÍ‡ÏË ‚ Ô‡ÏˇÚË/ÍÓÎË˜ÂÒÚ‚Ó ÒÓı‡ÌˇÂÏ˚ı ‚ Ô‡ÏˇÚË "
    "ÒË„Ì‡ÎÓ‚",
