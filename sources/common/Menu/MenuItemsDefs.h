...
static const ButtonBase name = { Item_Button, 0, false, Page_NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, funcPress, funcDraw };    \

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define DEF_TIME(name, titleRU, titleEN, hintRU, hintEN, keeper, funcActive, cur, h, mi, s, mo, d, y)   \
static const Time name = { Item_Time, 0, false, Page_NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, &cur, &h, &mi, &s, &mo, &d, &y };
...
static const SButton name = { Item_SmallButton, 0, false, Page_NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, funcPress, funcDraw, 0, 0}

#define DEF_SMALL_BUTTON_EXIT(name, keeper, funcActive, funcPress, funcDraw)                                                                \
static const SButton name = { Item_SmallButton, 0, false, Page_NoPage, &keeper, funcActive, {"Выход", "Exit", "Кнопка для выхода в предыдущее меню",               \
...
static const SButton name = { Item_SmallButton, 0, false, Page_NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, funcPress, funcDraw, hints##name, 2}
...
static const SButton name = { Item_SmallButton, 0, false, Page_NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, funcPress, funcDraw, hints##name, 3}
...
static const SButton name = { Item_SmallButton, 0, false, Page_NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, funcPress, funcDraw, hints##name, 5}
