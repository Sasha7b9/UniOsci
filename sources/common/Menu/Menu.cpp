...
{
    &mainPage,                      ///< Главная страница меню
    &pDisplay,                      ///< ДИСПЕЙ
    ...
    &pMemory_SetName,               ///< \brief Появляется перед сохранением файла на флешку для задания имени файла при соответствующей опции 
                                    ///< ВНЕШН ЗУ - Имя файла
    &pMeasures,                     ///< ИЗМЕРЕНИЯ
    ...
    &ppMeasures_FreqMeter,          ///< СЕРВИС - ЧАСТОТОМЕР
    ...
    (const Page *)1,                ///< СЕРВИС - РЕГИСТРАТОР
    &pHelp,                         ///< ПОМОЩЬ
    &pDebug,                        ///< ОТЛАДКА
    ...
    (const Page *)1,                ///< ОТЛАДКА - АЦП - ДОП СМЕЩ ПАМ
