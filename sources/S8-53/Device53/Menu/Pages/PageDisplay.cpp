...
static const arrayItems itemsSettings_Colors =
{
    ...
    //(void*)&mgcColorChannelAalt,          // TODO Ýòî äëÿ äîïîëíèòåëüíîãî öâåòà ïåðâîãî êàíàëà - äëÿ íàêîïëåíèÿ, íàïðèìåð.
    //(void*)&mgcColorChannelBalt,          // TODO Ýòî äëÿ äîï. öâåòà âòîðîãî êàíàëà - äëÿ íàêîïëåíèÿ, íàïðèìåð.    
};
